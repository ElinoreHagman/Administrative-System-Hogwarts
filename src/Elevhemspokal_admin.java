 ...
 */
public class Elevhemspokal_admin extends javax.swing.JFrame {

    private InfDB idb;

    // Creates new form Elevhemspokal_admin
    public Elevhemspokal_admin(InfDB idb) {
        initComponents();
        this.idb = idb;

        // Dessa metod anropas när sidan öppnas och fyller i poängen för elevhemmen, fyller dropdown-menyn med elevhem, och visar det ledande elevhemmet.
        fyllIPoang();
        fyllElevhemCombobox();
        VisaLedandeElevhem();
    }
    ...
    // Denna metod stänger sidan och tar användaren tillbaka till huvudsidan för admins.
        setVisible(false);
        ...
        try {
            ...
            if (Validering.KollaTomtFalt(txtInsertPoang)) {
                if (Validering.KollaFaltEfterSiffror(txtInsertPoang)) {
                    ...
                    // Detta lägger ihop poängen som redan är registrerad och den nytillagda poängen och uppdaterar databasen med den gemensamma summan.
